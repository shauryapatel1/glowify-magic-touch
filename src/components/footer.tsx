    ...
    <footer className="border-t border-white/10 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <GlowUpLogo className="mb-6" />
            <p className="text-white/50 max-w-xs">
              Elevate your videos with AI-powered effects, animations, and gestures.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-white/50 hover:text-white transition-colors">FAQ</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row sm:items-center justify-between">
          <p className="text-white/50 mb-4 sm:mb-0">© 2023 GlowUp AI. All rights reserved.</p>
